  ...
  return (
    <div className="App">
      ...
      <footer>
        ...
        <p>
          Passwords generated by password generators are much more secure than passwords that are created by humans. Password generators use a combination of numbers, uppercase and lowercase letters, and symbols to create a strong password that is difficult to crack.
        </p>
        <h1>
          How to use a Password Generator?
        </h1>
        <p>
          To use a password generator, you need to set the password length and select the types of characters you want to include in your password. Once you have set your preferences, click the "Generate Password" button to create a new password.
        </p>
